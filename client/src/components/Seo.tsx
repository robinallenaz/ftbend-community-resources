...
export default function Seo() {
  ...
  useEffect(() => {
    ...
    setMetaByProperty('og:image', 'https://res.cloudinary.com/dpus8jzix/image/upload/q_auto,f_auto,w_1200/ftbend-lgbtqia-logo_erkzpu.jpg');
    ...
    setMetaByName('twitter:image', 'https://res.cloudinary.com/dpus8jzix/image/upload/q_auto,f_auto,w_1200/ftbend-lgbtqia-logo_erkzpu.jpg');
